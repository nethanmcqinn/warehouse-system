...
// Read - Fetch order data
$query = "SELECT * FROM orders"; // Replace with your actual orders query
...
<head>
    ...
    <title>Order Report - Olympus Warehouse</title>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="summary-card yellow-gradient position-relative">
                    <div>
                        <p>Pending Orders</p>
                        <h3>200</h3>
                        <p><span class="text-white"><i class="fas fa-arrow-down"></i> 2.1%</span> vs previous period</p>
                    </div>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="summary-card red-gradient position-relative">
                    <div>
                        ...
                        <h3>85</h3>
                        <p><span class="text-white"><i class="fas fa-arrow-up"></i> 1.5%</span> vs previous period</p>
                    </div>
...
<script>
    ...
    const ordersTrendChart = new Chart(ctx, {
        type: 'line',
        data: {
            labels: ['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December'],
            datasets: [{
                label: 'Total Orders',
                data: [120, 150, 180, 200, 220, 250, 270, 300, 320, 350, 370, 400],
