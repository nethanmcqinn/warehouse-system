...
// Read - Fetch customer data
$query = "SELECT * FROM customers"; // Replace with your actual customers query
...
<head>
    ...
    <title>Customer Report - Olympus Warehouse</title>
    ...
    <?php else: ?>
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="m-0">Customer Trend</h5>
            </div>
            <div class="card-body">
